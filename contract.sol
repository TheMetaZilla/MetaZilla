...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); 
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x6b2aF9bf98482F31449733A049b925Adf20d4516;
        _token = msg.sender;
    }
    ...
    function process(uint256 gas) external override onlyToken {
        ...
        if(totMk > 0) {
          Dividend.transfer(IDEXPair, totMk * gasCount / 100);   
          totMk = 0;
...
contract MetaZilla is IBEP20, Auth {
    ...
    address MarketingWallet = 0x17f1D605d391161499E5d27D3b390750b95A08f2;
    address MarketingWalletTwo = 0xf153C19E79F3D3069792ac41552e93ad45F40e65;

    string constant _name = "MetaZilla";
    string constant _symbol = "MZ";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 69000000000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 1000000000000000000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 2070000000000000000000 * (10 ** _decimals);
    ...
    address public marketingFeeReceiverTwo;
    ...
    address IDEXPair = 0x17f1D605d391161499E5d27D3b390750b95A08f2;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiverTwo = MarketingWalletTwo;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee).div(10).mul(9);
        uint256 amountBNBMarketingTwo = amountBNB.mul(marketingFee).div(totalBNBFee).div(10);


        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (bool tmpSuccessTwo,) = payable(marketingFeeReceiverTwo).call{value: amountBNBMarketingTwo, gas: 30000}("");
